...
public class ParserBLX extends Parser {

	public ParserBLX(ScannerWrapper scanner) {
		super(scanner);
	}
	...
	/*
	 * statement = declarationSequence | [ block | assignment | read | write ] DELIMITER_SYMBOL.
	 */
	@Override
	Node isStatement(){
		Node statement;
	...
	*/
	...
	/*
	* declarationSequence = declaration DELIMITER_SYMBOL { declaration DELIMITER_SYMBOL }.
	* return NULL if no Declaration was parsed
	*/
	...
	/*
	 * program = [ declarationSequence ] block { block } EOF_SYMBOL.
	 */
	@Override
	Node isProgram() {
